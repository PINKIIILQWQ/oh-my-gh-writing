...
README 默认使用英语和用户交流时使用的语言。如果用户交流语言就是英语，只输出英语。用户提到多语言版本但未指定语言时，默认语言集合为：英语、简体中文、西班牙语、印地语、阿拉伯语、法语、葡萄牙语、日语、韩语。可按用户要求增加、删除或替换语言。
...
| VS Code README（成熟项目首页样例） | https://github.com/microsoft/vscode/blob/main/README.md |
