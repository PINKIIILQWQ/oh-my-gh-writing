...
如果目标仓库使用 Conventional Changelog、semantic-release、commit-and-tag-version、standard-version 或类似工具，把 generated changelog 当作事实来源，而不是重新发明分类。可以整理措辞、补充用户可读摘要，但不要改写工具从 commit metadata 推导出的版本、tag、compare link、breaking-change 或 commit 分组含义。
