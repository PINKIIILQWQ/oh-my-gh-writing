...
description: GitHub 写作规范 — Issue/PR/Review/Commit/文档/发布/设计/模板，每场景精细+中等 2 级标准，渐进式披露
---
...
| Badges | `![label](https://img.shields.io/...svg)` | README 状态栏 |
...
2. 我默认用中等复杂度（含全部必要部分），如需更精细可告知
3. 我会按场景问该问的可选项（README 徽章/PRI 截图等）
